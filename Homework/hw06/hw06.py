...
class VendingMachine:
    ...
    def vend(self):
        if self.inventory == 0:
            ...
            self.inventory -= 1
            balance = self.balance  # need to remember it
            self.balance = 0
            return 'Here is your candy and ${} change.'.format(balance - self.price)
    ...
    def restock(self, inventory):
        ...
        return 'Current {} stock: {}'.format(self.goods, self.inventory)
...
def is_bst(t):
    ...
    if length == 0:
        ...
        return bst_min(t.branches[0]) >= t.label or bst_max(t.branches[0]) <= t.label and is_bst(t.branches[0])
    elif length == 2:
        return bst_max(t.branches[0]) <= t.label and is_bst(t.branches[0]) and bst_min(t.branches[1]) and is_bst(t.branches[1])
    else:
        return False
