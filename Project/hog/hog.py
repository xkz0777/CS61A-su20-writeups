...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    "*** YOUR CODE HERE ***"
    return free_bacon(opponent_score) if num_rolls == 0 else roll_dice(
        num_rolls, dice)
    # END PROBLEM 3
...
def is_swap(player_score, opponent_score):
    ...
    return abs(player_score % 10 -
               opponent_score % 10) - opponent_score // 10 % 10 == 0
    # END PROBLEM 4
...
def play(strategy0,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 += score
            if feral_hogs and abs(prev_score0 - num_rolls) == 2:
                score0 += 3
            prev_score0 = score
            ...
            score1 += score
            if feral_hogs and abs(prev_score1 - num_rolls) == 2:
                score1 += 3
            prev_score1 = score
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    LAST_SCORE represents the current player's score before this turn.
    RUNNING_HIGN represents the last highest gain for the current player.
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    max_num, i = 1, 2
    max_score = make_averaged(roll_dice, trials_count)(max_num, dice)
    while i <= 10:
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score, opponent_score):
        if score < opponent_score:
            return 0
        elif score == opponent_score and bacon_score >= cutoff:
            return 0
    else:
